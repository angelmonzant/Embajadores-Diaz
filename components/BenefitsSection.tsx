...
const benefits = [
  ...
  },
  {
    ...
    description: "Rapikom asume el riesgo. Tú siempre cobras el 50% del monto de la venta."
  },
  {
    icon: Zap,
    title: "Pagos rápidos",
    subtitle: "en 14, 28 y 42 días",
  ...
  },
  {
    ...
    description: "Mientras más vendas, menos pagas. Comisiones desde 5.50% hasta 7.50%."
  }
]
      ...
      <div className="container-custom">
        <AnimatedSection className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Únete a la revolución del comercio digital y transforma tu negocio 
            con las mejores herramientas de financiamiento del mercado.
          </p>
        </AnimatedSection>
